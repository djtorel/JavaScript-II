...
// 50 small businesses to make a small donation on their behalf for some much
// needed updates to their facilities.  Each business has assigned a
...
// ==== Challenge 1: Use .forEach() ==== The event director needs both the first
...
// the event due to an ordering issue.  Get a list of runners with large sized
...
// .filter(), and .reduce().  I want you to think of potential problems you
// could solve given the data set and the 5k fun run theme.  Try to create and
